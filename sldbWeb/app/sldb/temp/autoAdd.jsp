...
<body>
	<form id="form1" runat="server" action="<%=request.getContextPath()%>/app/sldb/temp/add.action" method="post">
  ...
  <tr height="46">
    ...
    <td><div align="center"><span class="STYLE4"><input id="Text1" type="text" name="name" /></span></div></td>
    <td><div align="center"><span class="STYLE4">性别</span></div></td>
    <td><div align="center"><span class="STYLE4"><input id="Text2" type="text" name="sex" /></span></div></td>
    <td><div align="center"><span class="STYLE4">身份证号码</span></div></td>
    <td colspan="2"><div align="center"><span class="STYLE4"><input id="Text3" type="text" name="identify" /></span></div></td>
  ...
  <tr height="46">
    ...
    <td colspan="3"><div align="center"><span class="STYLE4"><input id="Text4" type="text" name="permanent" style="width:400px;"/></span></div></td>
    <td><div align="center"><span class="STYLE4">户口类别</span></div></td>
    <td colspan="2"><div align="center"><span class="STYLE4"><select id="nodeType" class="easyui-combobox"
								name="nodeType" url="<%=request.getContextPath()%>/app/system/dict/listDictByType.action?type=sldb.hukou" valueField="id"
								textField="text" editable="false"></select></span></div></td>
  </tr>
  <tr height="46">
    <td height="46"><div align="center"><span class="STYLE4">居住地址</span></div></td>
    <td colspan="6"><div align="center"><span class="STYLE4"><input id="Text6" type="text" name="address" style="width:500px;"/></span></div></td>
  </tr>
  <tr height="46">
    <td height="46"><div align="center"><span class="STYLE4">家庭人口</span></div></td>
    <td><div align="center"><span class="STYLE4"><input id="Text7" type="text" name="home" /></span></div></td>
    <td><div align="center"><span class="STYLE4">联系方式</span></div></td>
    <td colspan="2"><div align="left"><span class="STYLE4"><input id="Text4" type="text" name="contact" /></span></div></td>
    <td><div align="center"><span class="STYLE4">保障类别</span></div></td>
    <td colspan="2"><div align="center"><span class="STYLE4"><select id="type" class="easyui-combobox"
  ...
  <tr height="311">
    <td colspan="8" height="311"><div align="center"><span class="STYLE4"><textarea id="Text4" name="cause" style="width:800px;height:350px;overflow-x:hidden;overflow-y:hidden;border:none"/></textarea>　</span></div></td>
  </tr>
  <tr height="37">
